...
eyes = Dict{Symbol, Any}(
  :y =>
    @data ([529.0, 530.0, 532.0, 533.1, 533.4, 533.6, 533.7, 534.1, 534.8, 535.3,
     ...
     550.6, 551.2, 551.4, 551.5, 551.6, 552.8, 552.9, 553.2, NA])
     ,
  :N => 48,
  :alpha => [1, 1]
)
...
## MCMC Simulations
sim = mcmc(model, eyes, inits, 600, burnin=25, thin=2, chains=2
    )
describe(sim)
